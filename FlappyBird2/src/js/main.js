...
function start() {
    rootStretcher = new Stretcher(document.getElementById('canvas'), CONST.CANVAS.WIDTH, CONST.CANVAS.HEIGHT);
...
function assetsLoaded() {
    game = new BirdApp(rootStretcher);
    game.start();
}
